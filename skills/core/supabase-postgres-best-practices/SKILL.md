...
# REGLAS DE EJECUCIÓN (SUPABASE)
1. **Seguridad**: Diseñar "Action Gates" (puertas de acción) para operaciones críticas como RLS o migraciones destructivas.
2. **Modularidad**: Mantenimiento estricto de separaciones de esquemas y roles.
3. Justifica decisiones técnicas mediante planes EXPLAIN.
 ...
 **SKILLS ACTIVADAS**
SUPABASE-POSTGRES-BEST-PRACTICES  [OTRA]

**Applied**

SUPABASE-POSTGRES-BEST-PRACTICES  *[Descripción exacta de la ejecución]*
